      ...
      <div className="contentWrapperSignup">
        <div className="mainContentSignup">
          <div className="logoTextSignup">
            <h2 className="logoHeadingSignup">Squeedr</h2>
            <img
              style={{
                marginLeft: "3%",
                marginTop: "2%",
                ...
                <div className="headerSignup">
                  ...
                  <div className="header2ndHeadingMainDiv">
                    ...
                    <div className="textDivSignup">
                      <p className="headingFirstSignup">Forgot your password?</p>
                      <p className="headingSecondSignup" style={{fontSize:'16px'}}>
...
{/* 
        ...
        <div className="imageContainerSignup">
          ...
          <div className='carousel101'>
              <div className='dot101' style={{background:text===1?"#29BDEF": ""}} onClick={()=>{setText(1)}}>

              </div>
              <div className='dot101' style={{background:text===2?"#29BDEF": ""}} onClick={()=>{setText(2)}}>

              </div>
              <div className='dot101' style={{background:text===3?"#29BDEF": ""}} onClick={()=>{setText(3)}}>

              </div>
              <div className='dot101' style={{background:text===4?"#29BDEF": ""}} onClick={()=>{setText(4)}}>
